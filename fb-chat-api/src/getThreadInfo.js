                ...
                defaultFuncs
                        ...
                        .then(function (resData) {
                                ...
                                for (let i = resData.length - 2; i >= 0; i--) {
                                        const resItem = resData[i];
                                        if (!resItem) continue;
                                        const firstKey = Object.keys(resItem)[0];
                                        if (!firstKey || !resItem[firstKey]) continue;
                                        const data = resItem[firstKey].data;
                                        const threadInfo = formatThreadGraphQLResponse(data);
