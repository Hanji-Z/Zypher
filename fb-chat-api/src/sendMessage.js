                ...
                defaultFuncs
                        ...
                        .then(function (resData) {
                                ...
                                if (resData.error) {
                                        ...
                                        else if (resData.error === 1545023) {
                                                log.warn(
                                                        "sendMessage",
                                                        "Got error 1545023. Cannot send message to thread " +
                                                        threadID +
                                                        ". The thread may be restricted or the account may have messaging limitations."
                                                );
                                        }
                                        else {
